...
class UserKeyboards:
    ...
    def orders_project_kb(self, action_type: str):  # TODO: пофиксить
        kb = InlineKeyboardBuilder()  # 3
    ...
    def confirmation_of_creation_kb(self):
        kb = InlineKeyboardBuilder()
    ...
    def confirmation_of_deal_buyer_kb(self, seller_id: str | int, matched_orders_id: str | int):
        kb = InlineKeyboardBuilder()
    ...
    def confirmation_of_deal_seller_kb(self, buyer_id: str | int, matched_orders_id: str | int):
        kb = InlineKeyboardBuilder()
