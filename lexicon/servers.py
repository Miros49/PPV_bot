...
ARIZONA_RP_SERVERS = ['1.Phoenix', '2. Tucson', '3. Scottdale', '4. Chandler', '5. Brainburg', '6. Saint Rose',
                      '7. Mesa', '8. Red Rock', '9. Yuma', '10. Surprise', '11. Prescott', '12. Glendale',
                      '13. Kingman',
...
SERVERS = {
    ...
    'Radmir V RP': RADMIR_GTA5_SERVERS,
    'RMRP': RMRP_GTA5_SERVERS,
    'Arizona V': ARIZONA_RP_GTA5_SERVERS,
    'Grand RP': GRAND_RP_GTA5_SERVERS,
    'SMOTRArage': ['#1'],
    'Quant RP': ['#1'],
    ...
    'Матрёшка RP': MATRYOSHKA_RP_SERVERS,
